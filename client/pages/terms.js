...
const TermsPage = () => (
  <BodyWrapper>
    <Wrapper>
      <h3>Bxn.li Terms of Service</h3>
      <p>
        By accessing the website at <a href="https://bxn.li">https://bxn.li</a>, you are agreeing
      ...
      <p>
        In no event shall Bxn.li or its suppliers be liable for any damages (including, without
        limitation, damages for loss of data or profit, or due to business interruption) arising out
        of the use or inability to use the materials on Bxn.li website, even if Bxn.li or a Bxn.li
      ...
      <p>
        The materials appearing on Bxn.li website could include technical, typographical, or
        photographic errors. Bxn.li does not warrant that any of the materials on its website are
        accurate, complete or current. Bxn.li may make changes to the materials contained on its
        website at any time without notice. However Bxn.li does not make any commitment to update the
        materials.
      </p>
      <p>
        Bxn.li has not reviewed all of the sites linked to its website and is not responsible for the
        contents of any such linked site. The inclusion of any link does not imply endorsement by
        Bxn.li of the site. Use of any such linked website is at the {"user's"} own risk.
      </p>
      <p>
        Bxn.li may revise these terms of service for its website at any time without notice. By using
